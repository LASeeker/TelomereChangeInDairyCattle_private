...
```{r}
g1<- ggsurvplot(coxFit, data=init_change_dat, pval = 0.006, ggtheme = theme_minimal(), risk.table.y.text.col = T, risk.table.y.text = FALSE, legend.labs=c("Tertile 1 (most RLTL attrition)", "Tertile 2", "Tertile 3 (least RLTL attrition"))+ guides(colour = guide_legend(nrow = 3))+theme_survminer(40)

  
ggsurvplot(coxFit, data=init_change_dat, pval = 0.006, ggtheme = theme_minimal(), risk.table.y.text.col = T, risk.table.y.text = FALSE, legend.labs=c("Tertile 1 (most RLTL attrition)", "Tertile 2", "Tertile 3 (least RLTL attrition"))+theme_survminer(40)
...
##### Plot relationship of mean average RLTL and productive lifespan
```{r}
...
#N#### Repeat Cox proportional hazard model without without the fist measurement.
